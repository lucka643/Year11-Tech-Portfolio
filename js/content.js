    ...
    { t:"deck", id:"manufacturing", eyebrow:"2d · Manufacturing Analysis", head:"Manufacturing Analysis", thumbs:true,
      ...
      tabs:[
        ...
        { label:"Drill Press", img:"assets/mfg/drill-press.jpg", cap:"04 · Drill Press", title:"Drill Press",
          lead:"Drills straight, accurate holes, far safer and more precise than a hand drill. Perfect for the nail holes that the moving flaps on the wings pivot on, and for the holes that join the stabilizers to the body." },
  ...
  blocks:[
    ...
    { t:"split", id:"designer", eyebrow:"3a · Designer Influence Study", head:"Designer Influence Study",
      body:[
        ...
        "His way of thinking is exactly what I want my toy to follow. It is a simple, efficient shape where nothing is just decoration. The wings, fins and control surfaces all actually do something. That is why my jet has working flaps on the wings instead of being a solid block that only looks like a plane."
      ],
    ...
    { t:"gallery", id:"exploded", eyebrow:"3d · Exploded Drawing", head:"Exploded Drawing", tall:true,
      body:"My exploded drawing of the jet. It shows every part on its own and where each one goes, with the two main body pieces, the wings and their flaps, the intake, and the horizontal and vertical stabilizers.",
  ...
  blocks:[
    ...
    { t:"gallery", id:"additional-model", eyebrow:"4b · Additional Model", head:"Additional Model", feature:true,
      body:[
        ...
        "I did try the same idea on the elevators and the rudders, where the whole flap has one nail running all the way through it and the holes sit on the inside of the part. It worked, but those parts are much thinner than the main wings, and once I had a moving one in my hand I could see it was the bit that would snap first when a kid got hold of it. So in the end only the main wings get moving flaps, and the elevators and rudders are staying fixed."
      ],
      imgs:[
    ...
    { t:"cards", id:"justification", eyebrow:"4c · Model Justification", head:"Model Justification", cols:2,
      cards:[
        ...
        { img:"assets/models/addl-4.jpg", title:"Additional Model", meta:"Wing and control-surface mechanism",
          body:"My second model is smaller but just as important. It is a working test of the flap mechanism that makes my jet special. The control surfaces are the whole reason a kid would pick this jet over a solid one, so the nail and cutout joint had to be proven before I built it for real. Testing it in foam is also what showed me the thin tail parts were too fragile to have moving flaps, which is why only the two main wings ended up with them. If the flaps do not move smoothly then the playability that I chose this design for is gone." }
      ] },
    ...
    { t:"cards", id:"dev-conclusion", eyebrow:"4e · Development Testing Conclusion", head:"Development Testing Conclusion", cols:2,
      cards:[
        { title:"Sizing", meta:"From the foam model",
          body:"I put my foam model next to some average hand sizes for kids, and about 1.5 times bigger looked right. That comes out around 600 mm long with a wingspan of about 450 mm. It is a big toy. Nothing on it is small enough for a 3 year old to swallow, and it is still light enough to pick up in two hands and fly around." },
        { title:"Materials", meta:"From research and testing",
          body:"Pine for the main body and the canopy, because it is easy to shape and sand. MDF for the wings and flaps. I picked that mostly because it was the right thickness and I could actually get hold of it in the workshop. Cutting it on the bandsaw was fine. Sanding it and drilling it was a nightmare, especially the holes the nails go through. The axles and the rods the flaps tilt on are metal nails." },
        { title:"Finish", meta:"Changed my mind after the test board",
          body:"I painted it in the end instead of using a clear finish. I sanded every part smooth, sprayed it all with a white base coat so the colours would sit even, then sprayed on the real colours. Blue for the main body, orange for the intakes, and green for the wings, ailerons, rudders and flaps. I used gloss spray so it dries shiny and hard. The gloss helps get marks and stains off it, and it helps stop the wood splintering. I sprayed it instead of brushing it because a brush leaves brush strokes and I wanted it smooth. Once the paint is fully dried it is non toxic, which matters because a 3 year old might chew on it. The bright colours came from my colour research, where the toys that grabbed kids fastest were the bold ones." },
  ...
  blocks:[
    ...
    { t:"table", id:"production-plan", eyebrow:"5a · Production Plan", head:"Production Plan",
      ...
      rows:[
        ...
        ["Four","Make the control surfaces. Working from my working drawing, I marked where to cut on both main wings and cut the flaps free on the bandsaw. That gave me two moving flaps, one for each wing. The elevators and rudders stay as one solid piece, because they are too thin to take a moving flap. Then I sanded the front edge of each one into a half circle shape so it can rotate in place. A square edge just jams against the part next to it, but a rounded half circle edge lets it spin freely. I also left 2 mm of clearance on every side that sits next to another part, and that 2 mm is my tolerance.","Parts from step two · MDF flaps.","Pencil · Ruler · Bandsaw · Sander","Safety goggles · Apron · Closed shoes"],
        ["Five","Drill the axle channels and make the axles. First I drew lines on the outside of each part to show exactly where the channel goes, so I drill it straight and in the centre. If the channel is off centre the flap turns stiffly or not at all. Then I drilled the channels through both flaps and into the main wings behind them. After that I got nails that fit the holes, cut off the big end of each nail with pliers, the bit you hit with a hammer, and used the rest of the nail as the axle.","Metal nails.","Pencil · Ruler · Hand drill · Pliers","Safety goggles · Apron · Closed shoes"],
...
/* ============================== 07 EVALUATION & TESTING ============================== */
{
  ...
  blocks:[
    ...
    { t:"table", id:"against-spec", eyebrow:"7a · Evaluation Against Specification", head:"Evaluation Against Specification",
      ...
      rows:[
        ["Repairability","The product should have removable or replaceable parts. Strong materials and simple assembly should allow easy repairs.","Each wing flap sits on a metal nail that can be pulled out, so a damaged flap can be swapped for a new one without taking the whole jet apart. The stabilizers are pinned on with cut nails too, so they come off the same way. <i>(To confirm on the finished build.)</i>"],
        ...
        ["Playability","The product should be fun, safe, easy to hold, and encourage imagination or repeated use.","This is where the jet earns its place. A working flap on each wing, plus an opening canopy, gives a kid something to actually <b>do</b> with it, not just hold. There are no small loose parts and no sharp edges. <i>(To confirm in play testing.)</i>"]
      ] },
    ...
    { t:"gallery", id:"further", eyebrow:"7d · Taking the Idea Further", head:"Taking the Idea Further", tall:true,
      body:[
        "The next thing I would make is a wooden aircraft carrier for the jet to sit on. Right now the jet is just a jet. When a kid is done with it, it ends up on the floor or shoved in a box, because there is nowhere it is actually meant to go. A carrier fixes that. It gives the jet a home, and putting it away stops being a chore and becomes the last bit of the game.",
        "I would make it from pine and MDF like the jet, and paint it the same way so the two look like they belong together. The deck is mostly straight cuts. The tower is really just a few blocks stacked up with an angled bit on top, so it is well inside what I can already do. Honestly the main reason I want to build it is that one toy on its own gets boring fast. A jet with somewhere to land is a set, and a set is what a kid keeps coming back to."
      ],
